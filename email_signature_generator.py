...
for index, row in df.iterrows():
    ...
    html = f"""<br>
<table cellspacing="0" cellpadding="0" border="0" style="border-collapse: separate;table-layout: fixed;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;max-width:350px;" emb-background-style="" width="350">
    <tbody>
        <tr>
            <td style="color:#555555;font-size:13px;height:118px;padding-bottom:15px;font-family:Trebuchet MS, Verdana, Verdana Ref, sans-serif;">
                <p style="margin:.1px;">
                    <a href="#" style="border:0px;display:block;height:118px;" target="_blank">
                        <img src="YOUR LOGO URL" width="265" height="118" style="display:block;border:0px;" border="0" nosend="1" alt="">
                    </a>
                </p>
            </td>
        </tr>
